...
A better question I might say would be. Who, specifically, wants Jakarta to be jammed?

Of course not me. Nor the driver next to me. Not the ojol, the TJ, the pedestrian. Apparently not even the provincial government, which loses billions a day to productivity evaporating in stationary vehicles. Not the real-estate developer whose property value falls because access to it is hell-ish. Not the company whose employees arrive at the office already tired before the workday begins.

Nobody chose this. But it happens. Every. Single. Day.

Anon, say narcotics problem. BNN records transaction flows in Indonesia in the trillions of rupiah, with the user profile getting younger and poorer. Who wants this? The dealers, obviously. But ask an individual dealer honestly, he might probably say he wants out too. If only his competitor would leave first. The users don't want to be addicts. The users' families obviously don't want their savings to vanish into something that evaporates in minutes. The couriers don't want to get shot in the leg. The government doesn't want the country's reputation to become a case study in a regulatory-failure paper.

Still no antagonist but victims. And one industry that keeps growing.
...
There is something's running behind the scenes. It has no head office. It has no CEO. It has no cabinet meeting. It has no intent in any meaningful sense. But still writing most of modern human history.

I'm going to call it The Machine. (Originally "Moloch", from Slate Star Codex's "Meditations on Moloch".)

Wait, before you close the tab.
...
They are right about the pattern existing but they are wrong about its contents. How wrong? wrong on a spectacular level, because they assume the pattern needs conspirators. Needs someone in the shadows. Needs a secret meeting where The Decision is made.
...
It's not parliament. Not a boardroom. Not a cabinet meeting. The Machine was born in a pool of water on Earth roughly four billion years ago, before the first cell existed, in a vast ocean whose layout looked nothing like today's.
...
Whether it was RNA, peptides, or something more exotic, the chemistry isn't the point. But the implication is. The moment one self-replicating molecule appeared in a pool full of other molecules, the math changed permanently. Random competition between mortal molecules became competition between entities that produced more of themselves.

A simple law went into operation and it will reappear throughout this essay.
...
This is what Dawkins meant when he called genes "selfish". Genes don't have intent to be selfish. Technically genes don't have intent at all. Genes are chemical sequences that are more or less effective at producing copies of themselves, via the organisms they build.

"Selfish" here is a technical term. A successful strategy is a strategy that makes more copies. Not necessarily moral nor necessarily beautiful. But sufficient.

Wait. This is usually where people stop, either agreeing too fast or feeling insulted as "just animals". Both reactions are wrong.
...
I gave you the idea of an organism with two subsystems, selfish and cooperative. The question now is what determines which one runs.

The answer isn't personality. And it isn't faith. Neither your parents.

All three still matter, to some extent. But they operate on top of a more fundamental substrate. That substrate is the configuration of incentives around us at the moment a choice is being made.
...
It's just outcome. Not those fancy probabilistic or tendency. Munger spent sixty years observing humans in high-stakes decision-making positions, from Fortune 500 CEOs to politicians, and he came out with an uncomfortable conclusion. In the long run, in almost every case, incentive structure beats personality.

For instance.

Pay an annual bonus based on short-term profit to a finance executive. You get the 2008 crisis. None of them designed the crash or did they? They were just optimizing what you asked them to optimize.

TikTok has one objective function, watch-time. The result is a content industry currently rewiring the reward systems of primary-school children. The engineers at ByteDance don't actually want that. They're just optimizing the metric they're paid for. Starting to get it now?
...
Even altruism operates inside this field. Donations go up when the tax structure protects the giver. Volunteering goes up when there is public recognition. Philanthropy flows most strongly from people whose name can be put on a building. This doesn't deny sincerity. Even the most sincere motivation operates inside an incentive structure, not separate from it. Have you start noticing now, anon?

From all of this there is one claim.

**You don't fix outcomes by fixing people. You fix outcomes by fixing incentives.**

This will feel cynical to some readers. But hey cynical isn't automatically wrong, though. And the alternative, trying to fix outcomes by fixing people, has been tried for a few thousand years, and the track record is pretty clear.

## IV.

I gave you an organism that by default operates in its own interest. And that's a mechanical description not a moral one. It is the product of a selection process that has already killed its ancestors who didn't. Then I gave you the idea of incentives as a field surrounding every choice. The substrate where every choice actually happens.
...
Let me say it again with more sentences, I need this to land rightfully. From every player's point of view, defection is the dominant strategy, the choice that benefits you at the individual level regardless of what other players do. Because all players are rational, all of them then, defect. Because all of them defect, the collective outcome is worse than if all of them had cooperated. But no individual player can change the outcome unilaterally. If they chooses cooperation alone, all that does is make them lose faster.

Now look at Jakarta traffic through these glasses.

Every private-vehicle user makes a choice that is rational from their point of view. More comfortable than a packed TransJakarta. Safer than a motorbike in the rain. If the KRL schedule doesn't fit, the private car goes anyway. Rational individual choice, no? Now multiply that with millions of vehicles, that produces a city that cannot move.

The fix is structural and surely not moralizing. "Reduce private vehicles", stuck on pedestrian bridges, doesn't work. I'll demolish the moralizing approach in next section. What works is congestion pricing, the way Singapore and London do it. Transit that is genuinely faster than driving. Disincentives that show up directly in the wallet.
...
Are there dealers who feel guilty about the divorces they cause? Possibly. Are there middlemen and couriers who lose sleep over the savings of poor families moving into the shell companies of their bosses? Maybe. But the multipolar trap doesn't care an inch about anybody's feelings. The multipolar trap _only_ cares about one question. If actor X exits, will actor Y enter and fill the slot?
...
The same pattern runs the cases I mentioned in the first section. The candidate who refuses envelope politics loses to the one who doesn't, because the electorate in aggregate still responds to envelopes. The tobacco executive who wants to close his factory knows it will be bought by a competitor within three months. The content creator who refuses engagement bait gets out-competed until he has to choose between compromising and quitting.

Now that's The Machine.

The Machine is not a thing. Nor an organization. Nor it's a social class. The Machine is the name I'm giving to the attractor state that emerges from interactions of many rational agents, none of whom can change the outcome unilaterally.
...
And this is what makes individually good people produce a collectively bad world. They are not secretly evil. Inside a multipolar trap, "good" at the individual level does not guarantee "good" at the collective level. Two different variables. But we, from primary school through Friday prayer through motivational posts on Instagram, are taught over and over that they are the same thing.

That is the most dangerous lie we still maintain as a civilization.

## V.

Every culture that has ever faced a multipolar trap has had the same default response. A flipping sermon. Never a structural reform. Never redesigned incentives. Heck.

"Don't take bribes." "Don't be greedy." "Think of your grandchildren." Every billboard dude. Every pulpit. Every presidential address. Every corporate CSR campaign. Every Instagram caption from a public figure. Every parent giving advice to their kid.

All. Of. It. Does. Not. Work. Oh god please some do something that actually matters.

The audience agrees, mostly. The majority, if asked, will say they intend well. But when the moment of choice arrives? The majority, if observed, defect anyway.
...
If any of you have ever read Taleb on virtue signalling and nodded yet your feed is still full of moral posts not followed by any structural action, you are the subject of this paragraph. So am I. Also Taleb will spit on you.

## VI.

Stop sermonizing. Start engineering.

That's one sentence that I'm going to translate.

At the policy level, engineering means Pigouvian taxes on known externalities. Indonesia's cigarette excise, one of the most successful public-health interventions of the last two decades, has measurably reduced teenage smoking. High schoolers don't need divine guidance. The cigarettes just need to be more expensive. Carbon tax follows the same logic for emissions. Sugar taxes follow the same logic in Indonesia. Not elegant really, not inspiring as well, but at least it works.

At the institutional level, engineering means coordination mechanisms that bite. Elinor Ostrom won the 2009 Nobel in Economics for documenting that commons, under certain conditions, can be managed without privatization and without state control. The conditions are specific. Clear boundaries on who is in and who is out. Rules made by the participants themselves. Monitoring by or for the participants. Graduated sanctions for defectors. Cheap and fast conflict-resolution mechanisms. The lesson scales from fishing cooperatives to platform regulation.

At the individual level, engineering means exposing defection and shrinking its cover. The Machine is strongest when defection is invisible. The tobacco industry doesn't collapse as long as smoking looks normal or even cool for you teenage boys. Money politics doesn't collapse as long as envelopes are handed out in private or acceptable for majority of people. Every time you, as an individual, make defection visible, make the normalization uncomfortable, make cooperation socially defensible, you are pulling one vector against The Machine. A small one. But never zero.

None of this sounds epic. But that's a feature, not a bug. Anyway that is one cool reference right? Back to the topic, epic solutions to multipolar traps, throughout history, almost always become tyrannies. Epic solutions require one actor strong enough to coerce every other player into cooperation at once. That actor, once given the power, rarely gives it back.

What works isn't heroic, it is boring. Tax goes up 5 percent. New disclosure regulation. Routine audits. Certification that makes defection expensive. Reward schemes that make cooperation more profitable.

But look at the data. Boring beats heroic. Repeatedly.
...
The Machine will not be defeated. Maybe it won't be. Even worse, maybe it can't be. But it can be re-engineered. Every incentive we change, however small, shifts an equilibrium that every other player now has to re-optimize around. That's how multi-agent systems work. That's also how we get out.

This is neither optimism nor pessimism. It's a flipping description.
