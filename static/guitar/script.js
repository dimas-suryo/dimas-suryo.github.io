...
const C={
root:{title:"Apa yang Kamu Juga Perlu Tahu Soal Gitar",sub:"Catatan seorang gitaris yang akhirnya ngerti kenapa teori itu penting. Bukan textbook, bukan kursus — lebih ke hal-hal yang harusnya ada yang kasih tau ke kamu pas baru mulai, tapi nggak ada.",intro:"Banyak gitaris main bertahun-tahun sebelum akhirnya serius pegang teori. Penyesalan yang paling sering: nunda kelamaan gara-gara ngira teori bikin permainan jadi kaku. Padahal kebalikannya — teori itu yang ngebebasin. Halaman ini peta dari semuanya, disusun dari nol, urutannya kayak yang harusnya kamu dapet dari awal. Klik node mana aja di mind map, atau toggle ke mode esai kalau mau baca runtut.",secs:[{l:"Kenapa Repot Belajar Teori?",t:"Teori musik bukan aturan yang ngebatasin kamu. Anggap aja <strong>bahasa buat ngejelasin</strong> apa yang udah kejadian di sebuah lagu — kenapa bagian ini enak didengar, kenapa yang itu bikin merinding. Begitu kamu paham, kamu bisa <strong>ngobrol sama musisi lain tanpa bingung</strong>, bedah lagu yang kamu suka, dan berhenti muter-muter di pola yang itu-itu aja tanpa tahu kenapa jalan."},{l:"Alur Belajar",li:["1. <strong>Sound & Acoustics</strong> : suara secara fisik","2. <strong>Notes & Tuning</strong> : sistem nada dan frekuensi","3. <strong>Intervals</strong> : DNA chord dan scale","4. <strong>Scales</strong> : palette warna musik","5. <strong>Scale Math</strong> : logika matematika scale","6. <strong>Chord Construction</strong> : triad, 7th, extensions","7. <strong>Diatonic Harmony</strong> : family chord, fungsi harmoni","8. <strong>Modes</strong> : 7 warna dari 1 parent scale","9. <strong>Advanced Harmony</strong> : cadence, modulasi","10. <strong>Rhythm & Meter</strong> : struktur waktu","11. <strong>Guitar Essentials + sub-topics</strong>","12. <strong>Ear Training, Practice & Mindset</strong>"]},{l:"Tiga Pilar Musikalitas",li:["<strong>Ear Training</strong> : dengar, kenali, reproduksi","<strong>Fretboard Knowledge</strong> : tahu setiap nada tanpa berpikir","<strong>Rhythmic Fluency</strong> : nada tepat di waktu tepat"]}],tk:"Teori itu GPS, bukan penjara. Tugasnya ngejelasin 'kenapa' dari musik yang udah kamu rasain — biar kamu nggak nyasar tiap mau bikin sesuatu yang baru.",refs:["Aldwell, E., Schachter, C. (2018). Harmony and Voice Leading, 5th ed. Cengage.","Levine, M. (1995). The Jazz Theory Book. Sher Music Co."]},

sound:{title:"Sound & Acoustics",sub:"Suara secara fisik: gelombang, frekuensi, dan gimana telinga ngolah semuanya.",intro:"Bagian ini sering dilewat karena kerasa terlalu 'sains'. Sayang banget. Begitu kamu paham kenapa fifth bunyinya stabil dan tritone bikin tegang, semua teori chord setelahnya jadi masuk akal, bukan sekadar hafalan.",secs:[{l:"Apa Itu Suara?",t:"Suara itu <strong>gelombang mekanis longitudinal</strong>: getaran yang merambat lewat udara sekitar 343 m/s, bikin daerah rapat (kompresi) dan renggang (rarefaction) bergantian."},{l:"4 Properti Suara",tbl:{h:["Properti","Fisik","Persepsi","Satuan"],r:[["Frequency","Siklus/detik","Pitch","Hz"],["Amplitude","Variasi tekanan","Loudness","dB"],["Timbre","Komposisi overtones","Warna suara",""],["Duration","Lama getaran","Panjang nada","s"]]}},{l:"Harmonic Series",t:"Satu senar nggak getar di satu frekuensi doang — dia getar di 1/2, 1/3, 1/4 panjangnya sekaligus, dan itu yang ngehasilin <strong>overtones</strong>. Campuran kekuatan tiap harmonik inilah yang bikin tiap instrumen punya <strong>warna suara</strong> sendiri."},{l:"Consonance dan Dissonance",t:"Rasio frekuensi yang sederhana kedengeran konsonan (oktaf 2:1, fifth 3:2). Yang rasionya rumit kedengeran disonan. Dua-duanya bukan masalah — keduanya <strong>alat ekspresi</strong>, tinggal kamu mau pakai yang mana."}],tk:"Pada akhirnya semua teori musik bisa ditarik balik ke hubungan matematika antar frekuensi.",refs:["Rossing, T. D. (2002). The Science of Sound, 3rd ed. Addison Wesley.","Helmholtz, H. von (1885/1954). On the Sensations of Tone. Dover."]},

notes:{title:"Notes & Tuning Systems",sub:"12 nada, A = 440 Hz, dan perdebatan temperament yang udah jalan berabad-abad.",secs:[{l:"12-Note Chromatic System",t:"Musik Barat motong satu oktaf jadi <strong>12 nada berjarak sama</strong> (12-TET). Yang natural ada 7: C D E F G A B. Khusus E ke F dan B ke C, jaraknya udah cuma satu semitone."},{l:"Matematika 12-TET",t:"Tiap semitone naik dengan rasio <strong>¹²√2 ≈ 1.05946</strong>. Dari A4 = 440 Hz, A♯4 jadi 466.16 Hz, dan setelah 12 semitone ketemu 880 Hz alias naik satu oktaf pas."},{l:"Standard Guitar Tuning",tbl:{h:["String","Nada","Hz"],r:[["6","E2","82.41"],["5","A2","110.00"],["4","D3","146.83"],["3","G3","196.00"],["2","B3","246.94"],["1","E4","329.63"]]}},{l:"Alternate Tunings",li:["<strong>Drop D</strong> (D A D G B E) : power chords 1 jari","<strong>Open G</strong> (D G D G B D) : Keith Richards, blues slide","<strong>DADGAD</strong> : Celtic/folk, Jimmy Page","<strong>Open D</strong> (D A D F♯ A D) : slide, fingerstyle"]}],tk:"12-TET ngorbanin interval yang benar-benar murni, ditukar sama kebebasan main di semua 12 key tanpa nyetem ulang.",refs:["Isacoff, S. (2001). Temperament. Vintage.","Duffin, R. W. (2007). How Equal Temperament Ruined Harmony. Norton."]},

intervals:{title:"Intervals",sub:"Jarak antara dua nada — unit paling kecil yang nyusun semua hal di musik.",secs:[{l:"13 Interval dalam 1 Oktaf",tbl:{h:["ST","Nama","Simbol","Rasio","Karakter"],r:[["0","Perfect Unison","P1","1:1","Identik"],["1","Minor 2nd","m2","16:15","Tegang"],["2","Major 2nd","M2","9:8","Terbuka"],["3","Minor 3rd","m3","6:5","Sedih"],["4","Major 3rd","M3","5:4","Cerah"],["5","Perfect 4th","P4","4:3","Kuat"],["6","Tritone","TT","45:32","Disonan"],["7","Perfect 5th","P5","3:2","Stabil"],["8","Minor 6th","m6","8:5","Misterius"],["9","Major 6th","M6","5:3","Hangat"],["10","Minor 7th","m7","9:5","Blues"],["11","Major 7th","M7","15:8","Dreamy"],["12","Octave","P8","2:1","Identik+"]]}},{l:"Klasifikasi",li:["<strong>Perfect</strong> (P1, P4, P5, P8) : tidak punya major/minor","<strong>Major/Minor</strong> (2nd, 3rd, 6th, 7th) : beda 1 semitone","<strong>Augmented</strong> : +1/2 step dari perfect/major","<strong>Diminished</strong> : -1/2 step dari perfect/minor"]},{l:"Inversion",t:"Nama interval plus inversionnya selalu jumlahnya 9, dan semitone-nya jumlahnya 12. Contoh: M3 (4 semitone) kalau dibalik jadi m6 (8 semitone). Major selalu jadi minor pas dibalik."}],tk:"Kuasai 13 interval ini — secara teori sekaligus lewat telinga — dan kamu udah pegang sekitar 80% teori musik.",refs:["Kostka, S. & Payne, D. (2012). Tonal Harmony, 7th ed. McGraw-Hill."]},

scales:{title:"Scales",sub:"Kumpulan nada yang ditata rapi — palette warna yang nentuin karakter sebuah musik.",intro:"Kalau kamu cuma hafal kotak minor pentatonik dan stuck di situ bertahun-tahun, bagian ini yang bakal ngebebasin. Scale itu bukan posisi jari, tapi rumus jarak yang bisa kamu geser ke mana aja di fretboard.",secs:[{l:"Major Scale",t:"Pola jaraknya: <strong>W-W-H-W-W-W-H</strong>. Ini scale paling fundamental — semua teori tonal lain didefinisikan relatif ke dia."},{l:"Natural Minor",t:"Pola jaraknya: <strong>W-H-W-W-H-W-W</strong>. Bedanya sama major: nada 3, 6, dan 7-nya diturunin (♭3, ♭6, ♭7), dan itu yang bikin terdengar lebih gelap."},{l:"Harmonic Minor",t:"Natural minor tapi nada ke-7-nya dinaikin. Efeknya: muncul jarak Augmented 2nd yang khas, dan chord V-nya berubah jadi Dominant 7 — itu yang bikin resolusinya kerasa kuat."},{l:"Pentatonic",tbl:{h:["Scale","Formula","Karakter"],r:[["Major Pent","1 2 3 5 6","Cerah, melodis"],["Minor Pent","1 ♭3 4 5 ♭7","Bluesy, raw"]]}},{l:"Blues Scale",t:"Minor pentatonic ditambah ♭5 alias blue note: 1 ♭3 4 ♭5 5 ♭7. Satu nada itu doang yang bikin semuanya kedengeran ngeblues."}],tk:"Major scale jadi titik acuan utama. Minor pentatonic jadi scale improvisasi yang paling sering dipakai orang.",refs:["Persichetti, V. (1961). Twentieth-Century Harmony. Norton."]},

math:{title:"Mathematics of Scale",sub:"Logika dan simetri matematika di balik cara scale dibangun.",secs:[{l:"Tetrachord",t:"Major scale sebenernya <strong>2 tetrachord yang identik</strong> (masing-masing W-W-H), disambung satu Whole Step di tengah sebagai jembatan."},{l:"Visualisasi",cd:"Tetrachord 1     Bridge     Tetrachord 2\n W _ W _ H         W         W _ W _ H\n 1   2   3   4         5   6   7   8\n\nC Major: C_D_E_F  <W>  G_A_B_C"},{l:"Circle of Fifths",t:"Tetrachord kedua dari satu key bakal jadi tetrachord pertama buat key berikutnya, dan tiap pindah nambah satu sharp. Tiap key naik satu Perfect 5th — itulah kenapa namanya Circle of Fifths."}],tk:"Tetrachord plus Circle of Fifths itu fondasi matematika dari seluruh harmoni tonal.",refs:["Benson, D. (2006). Music: A Mathematical Offering. Cambridge UP."]},

chords:{title:"Chord Construction",sub:"Chord itu interval yang ditumpuk, bukan hafalan posisi jari.",secs:[{l:"4 Triad",tbl:{h:["Tipe","Formula","Stack"],r:[["Major","1 3 5","M3+m3"],["Minor","1 ♭3 5","m3+M3"],["Dim","1 ♭3 ♭5","m3+m3"],["Aug","1 3 ♯5","M3+M3"]]}},{l:"5 Jenis 7th Chord",tbl:{h:["Tipe","Formula","Simbol"],r:[["Maj7","1 3 5 7","Cmaj7"],["Dom7","1 3 5 ♭7","C7"],["Min7","1 ♭3 5 ♭7","Cm7"],["Half-Dim","1 ♭3 ♭5 ♭7","Cø"],["Dim7","1 ♭3 ♭5 ♭♭7","C°7"]]}},{l:"Extensions",t:"9th itu nada 2nd yang dinaikin satu oktaf, 11th itu 4th, 13th itu 6th. Fungsinya nambah warna tanpa ngubah peran dasar chordnya."},{l:"Suspended",t:"Sus4 (1 4 5) dan Sus2 (1 2 5) ngeganti nada ke-3 dengan nada 4 atau 2, jadi chordnya kedengeran menggantung — nggak major, nggak minor."}],tk:"Chord itu tumpukan interval. Yang bikin Dominant 7 spesial: ada tritone di dalamnya, dan tritone itu yang narik chord buat resolve.",refs:["Levine, M. (1995). The Jazz Theory Book. Sher Music.","Piston, W. (1987). Harmony, 5th ed. Norton."]},
...
harmony:{title:"Advanced Harmony",sub:"Cadence, secondary dominant, dan modulasi.",secs:[{l:"4 Cadence",tbl:{h:["Cadence","Gerak","Kesan"],r:[["Perfect Authentic","V lalu I","Final"],["Plagal","IV lalu I","Amen"],["Half","? lalu V","Menggantung"],["Deceptive","V lalu vi","Kejutan"]]}},{l:"Secondary Dominants",t:"Dom7 dadakan yang ngarah ke chord diatonic selain I, ditulis V/x. Di key C: A7 itu V/ii, D7 itu V/V — kayak minjam tarikan dominant buat sebentar."},{l:"Tritone Substitution",t:"Satu Dom7 bisa diganti Dom7 lain yang jaraknya tritone — G7 ditukar D♭7. Bisa, karena dua-duanya punya tritone yang sama persis di dalamnya."},{l:"Modulasi",li:["<strong>Direct</strong> : langsung pindah key","<strong>Pivot Chord</strong> : chord di kedua key sebagai jembatan","<strong>Common Tone</strong> : 1 nada dipertahankan","<strong>Chromatic</strong> : gerakan semitone"]}],tk:"Cadence itu tanda baca dalam harmoni. Semua teknik di sini intinya main sama ekspektasi pendengar.",refs:["Piston, W. (1987). Harmony, 5th ed. Norton."]},

rhythm:{title:"Rhythm & Meter",sub:"Rhythm itu soal kapan nada dibunyiin. Sama pentingnya sama nada apa yang dibunyiin.",secs:[{l:"Time Signatures",tbl:{h:["Sig","Arti","Contoh"],r:[["4/4","4 quarter/measure","90%+ pop/rock"],["3/4","3 quarter/measure","Waltz"],["6/8","6 eighth (2x3)","Nothing Else Matters"],["5/4","5 beats","Take Five"]]}},{l:"Note Values",cd:"Whole=4 beats  Half=2  Quarter=1\nEighth=1/2  Sixteenth=1/4  Triplet=3 in 2"},{l:"Syncopation",t:"Penekanan jatuh di offbeat, bukan di ketukan kuat. Ini inti dari groove di funk, reggae, dan jazz."}],tk:"Time signature itu cara ngelompokin ketukan. Syncopation itu sumber groove. Dan metronome wajib dikuasai.",refs:["London, J. (2012). Hearing in Time. Oxford UP."]},
